...
POST
/workflows/run
curl -X POST 'http://1.14.148.230/v1/workflows/run' \
...
POST
/workflows/:workflow_id/run
curl -X POST 'http://1.14.148.230/v1/workflows/{workflow_id}/run' \
--header 'Authorization: Bearer {api_key}' \
--header 'Content-Type: application/json' \
--data-raw '{
  "inputs": {},
...
GET
/workflows/run/:workflow_run_id
curl -X GET 'http://1.14.148.230/v1/workflows/run/:workflow_run_id' \
...
POST
/workflows/tasks/:task_id/stop
curl -X POST 'http://1.14.148.230/v1/workflows/tasks/:task_id/stop' \
-H 'Authorization: Bearer {api_key}' \
-H 'Content-Type: application/json' \
...
POST
/files/upload
curl -X POST 'http://1.14.148.230/v1/files/upload' \
--header 'Authorization: Bearer {api_key}' \
...
GET
/end-users/:end_user_id
curl -X GET 'http://1.14.148.230/v1/end-users/6ad1ab0a-73ff-4ac1-b9e4-cdb312f71f13' \
--header 'Authorization: Bearer {api_key}'
...
GET
/workflows/logs
curl -X GET 'http://1.14.148.230/v1/workflows/logs'\
--header 'Authorization: Bearer {api_key}'
...
GET
/info
curl -X GET 'http://1.14.148.230/v1/info' \
-H 'Authorization: Bearer {api_key}'
...
GET
/parameters
 curl -X GET 'http://1.14.148.230/v1/parameters'
...
GET
/site
curl -X GET 'http://1.14.148.230/v1/site' \
-H 'Authorization: Bearer {api_key}'
